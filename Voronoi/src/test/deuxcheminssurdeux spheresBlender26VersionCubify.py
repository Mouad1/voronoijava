...
def f(th):
    return (dist*cos(l1*th)*cos(l2*th),dist*sin(l1*th)*cos(l2*th),dist*sin(l2*th))

def g(th):
    #return (dist2*cos(4*th)*cos(4*th),dist2*sin(4*th)*cos(4*th),dist2*sin(4*th))
    return (dist2*cos(k1*th)*cos(k2*th),dist2*sin(k1*th)*cos(k2*th),dist2*sin(k2*th))
