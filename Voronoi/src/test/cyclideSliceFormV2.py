...
myMeshBase=cyclide2(mu,c,a,nbc,nbd)
colorize(myMeshBase,[1,0,0])

ob = bpy.data.objects.new('XVillarceau'+str(numero), myMeshBase)
...
for i in range(nbCercles):
    ...
    myMesh=cylindre(vilain[1]*reduc,ep,500)
