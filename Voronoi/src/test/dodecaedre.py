...
def transfo(me,vectrans,angalp,angbet,autoangle):
  ...
  transly=mathutils.Matrix.Translation(35*Vector(vectrans))
...
for ind in range(nbPoly):
 ...
 # colorer le polygone
 color(myMesh,[rouge[colorIndice[ind%nbPoly]],vert[colorIndice[ind%nbPoly]],bleu[colorIndice[ind%nbPoly]]])
